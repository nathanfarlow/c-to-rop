# PEP 563. It will become the default in Python 3.10.
...
class Parser:
    ...
    def _parse_line(self) -> None:
        ...
        if self.peek() == ":":
            ...
            elements = {"data": self.data_elements,
                        "text": self.text_elements}[self.segment]
            ...
            if first_word == ".text":
                ...
                if not (self.peek() == "\"" and self.line[-2] == "\""):
                    raise ParserError(
                        self, "found .string but couldn't understand string literal")
            ...
            while True:
                ...
                if self.peek() == ",":
                    ...
                    assert self.peek() == "\n", ParserError(
                        self, "unknown character: " + repr(self.peek()))
...
class ParserError(RuntimeError):
    def __init__(self, parser: Parser, message: str):
        super().__init__(
            f"{message} at line {parser.line_num + 1}, col {parser.idx}")
